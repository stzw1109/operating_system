...
#define PETROL_TANK_VOLUME 1000000
//for W5500
...
/* USER CODE BEGIN PV */
//petrol tank volume
volatile uint32_t petrol_tank_volume = PETROL_TANK_VOLUME;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_1|GPIO_PIN_4|stop_Board1_Pin, GPIO_PIN_SET);
