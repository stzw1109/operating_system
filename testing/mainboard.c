...
void func_updateCloud(void *argument)
{
  ...
  for(;;)
  {
	  mqttnetwork_connect(&network, "4c5e19745ee742f4aa5c4a42bf15d3a8.s1.eu.hivemq.cloud", 8883); // Use 8883 for TLS or 1883 for no TLS
...
void func_updatePetrol(void *argument)
{
  ...
  for(;;)
  {
	  if(pump1_status && petrol_sufficient){
			 petrol_tank_volume--;
			 pump1_volume++;
	  }
